//LB Assignment no:44, Question no:4.
//Write java program to accept directory name from user and write data of all files with its name into one newly created file named as "Marvellous.txt".
