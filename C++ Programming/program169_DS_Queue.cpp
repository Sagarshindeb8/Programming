...
void Queue<T>::Dequeue() // DeleteFirst
{
	...
	if(Count == 0) //if LL is empty also Head == NULL
	{
...
/*
	if(Count == 1) //if LL contains only 1 node
	{
		no = Head -> data;
		delete Head;
		Head = NULL;
...
int main()
{
	...
	obj1.Display();
	cout<<"Number of elements in the Queue:"<<obj1.CountNode()<<endl;
